...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="sticky top-0 z-50 flex items-center justify-between w-full py-4 px-4 md:px-16 lg:px-24 xl:px-32 backdrop-blur border-b text-white  bg-[#004d1a]">
        <Link to="/">
          ...
          {!session?.user ? (
            ...
            <>
              <button className="bg-white/10 px-5 py-1.5 text-xs sm:text-sm border text-gray-200 rounded-full">
                Credits: <span className="text-[#00FFAB]">{credits}</span>
              </button>
