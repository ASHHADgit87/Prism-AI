...
const Home = () => {
  ...
  return (
    <>
      ...
      >
        <h1 className="text-center text-[40px] leading-[48px] md:text-6xl md:leading-[70px] mt-35 font-semibold max-w-3xl">
        ...
        >
          ...
          <button className="border-2 border-[#004d1a] ml-auto flex items-center gap-2 bg-gradient-to-r from-[#004d1a] via-[#00FFAB] to-[#0073b3] rounded-md px-4 py-2 text-white font-medium hover:brightness-110 transition">
            {!loading ? (
              "Create with AI"
            ) : (
              <>
