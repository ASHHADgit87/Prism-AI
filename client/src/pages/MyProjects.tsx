    ...
    <div className='px-4 md:px-16 lg:px-24 xl:px-32'>
        {loading ? (
            <div className='flex items-center justify-center h-[80vh]'>
                <Loader2Icon className='size-7 animate-spin text-[#004d1a]'/>
            </div>
        ) : projects.length > 0 ?(
            <div className='py-10 min-h-[80vh]'>
                <div className='flex items-center justify-between mb-12'>
                    <h1  className='text-2xl font-medium text-white'>My Projects</h1>
                    <button onClick={() => navigate('/')} className='flex items-center gap-2 text-white px-3 sm:px-6 py-1 sm:py-2 rounded bg-linear-to-br from-[#004d1a] to-[#00331a] hover:opacity-90 active:scale-95 transition-all'><PlusIcon size={18}/>Create More</button>
                </div>
            ...
            <div className='flex flex-col items-center justify-center h-[80vh]'>
                ...
                <button onClick={() => navigate('/')} className='text-white px-5 py-2 mt-5 rounded-md bg-[#004d1a] hover:bg-[#004d1a] active:scale-95 transition-all'>
                    Create More
                </button>
            </div>
